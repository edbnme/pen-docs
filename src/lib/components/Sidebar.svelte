<script lang="ts">
  ...
  import { getDocPath, getDocSections } from "$lib/docs";
...
<div class="flex h-full flex-col">
  <div class="p-5 pb-3">
    <a href={getDocPath("readme")} onclick={onNavigate} class="block group">
      <div
  ...
  <div class="px-3 pb-3">
    <button
      ...
      class="w-full flex items-center gap-2 px-3 py-2 text-[0.8125rem] text-gray-400 bg-white dark:bg-white/4 border border-gray-200 dark:border-gray-800/60 rounded-lg hover:border-gray-300 dark:hover:border-gray-700 hover:text-gray-500 dark:hover:text-gray-300 transition-all duration-200 cursor-pointer shadow-sm shadow-gray-900/3 dark:shadow-none"
    >
      <svg
        ...
        {#each section.docs as doc (doc.slug)}
          ...
          <a
            ...
            class="block py-2 px-3 rounded-lg text-[0.8125rem] transition-all duration-200 {isActive
              ? 'text-gray-900 dark:text-gray-50 bg-gray-200/60 dark:bg-white/8 font-medium'
              : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/4'}"
          >
            {doc.title}
          </a>
        {/each}
  ...
  >
    <a
      ...
      class="flex items-center gap-2 px-3 py-2 rounded-lg text-[0.8125rem] text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/4 transition-all duration-200"
    >
      <GithubIcon />
