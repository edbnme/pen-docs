...
export const docs: DocEntry[] = [
  ...
  },
  {
    ...
    section: "Users",
    description:
      "Proven tool chains for memory leaks, page load optimization, bundle audits, and more.",
  },
  {
  ...
  },
  {
    ...
    section: "Contributors",
    description:
      "Streaming large CDP payloads (heap snapshots, traces) to disk with constant memory.",
  },
  {
    ...
    section: "Contributors",
    description:
      "MCP Go SDK integration, typed tool handlers, transports, and concurrency patterns.",
  },
  {
    ...
    section: "Contributors",
    description:
      "Step-by-step guide to adding new tools to PEN with real code examples.",
  },
  {
    slug: "output-design",
    title: "Output Design",
    section: "Contributors",
    description:
      "How PEN formats tool output for LLM consumption: token budgets, tables, and sections.",
  },
  {
    slug: "error-handling",
    ...
    section: "Contributors",
    description:
      "Error handling across CDP, MCP, and browser interactions. Edge cases and recovery.",
  },
  {
    slug: "references",
    title: "References",
    section: "Contributors",
    description:
      "CDP spec references, Go library versions, prior art, and project links.",
  },
];
