...
>
  ...
  <ul>
    <li><strong>Token budget</strong>: Output is capped to fit LLM context windows. Big result sets (e.g., 500 network requests) get trimmed to the top N.</li>
    <li><strong>No binary blobs</strong>: Everything is text. Screenshots are base64 PNGs in <code>mcp.ImageContent</code>.</li>
    <li><strong>Self-contained</strong>: No "go look at this file" references. The LLM should have everything it needs in the response.</li>
    <li><strong>Structured, not prose</strong>: Tables and labeled sections. LLMs parse structured text better than paragraphs.</li>
  </ul>
  ...
  <div class="table-wrapper">
    <table>
      <thead><tr><th>Tool</th><th>Typical Output</th><th>Upper Bound</th></tr></thead>
      <tbody>
        <tr><td><code>pen_performance_metrics</code></td><td>~30 lines</td><td>50 lines</td></tr>
        <tr><td><code>pen_heap_snapshot</code></td><td>~40 lines</td><td>100 lines</td></tr>
        <tr><td><code>pen_network_waterfall</code></td><td>~50 lines</td><td>120 lines</td></tr>
        <tr><td><code>pen_cpu_profile</code></td><td>~40 lines</td><td>100 lines</td></tr>
        <tr><td><code>pen_source_content</code></td><td>~200 lines</td><td><code>maxLines</code> param</td></tr>
        <tr><td><code>pen_capture_trace</code></td><td>~50 lines</td><td>120 lines</td></tr>
        <tr><td><code>pen_trace_insights</code></td><td>~60 lines</td><td>150 lines</td></tr>
        <tr><td><code>pen_console_messages</code></td><td>~30 lines</td><td>100 lines</td></tr>
        <tr><td><code>pen_lighthouse</code></td><td>~50 lines</td><td>120 lines</td></tr>
      </tbody>
    </table>
  </div>
  ...
  <p>
    PEN uses <code>internal/format/output.go</code> for consistent output across
    tools.
  </p>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr><td><code>format.Bytes(n)</code></td><td>Human-readable bytes</td><td><code>82.4 MB</code></td></tr>
        <tr><td><code>format.Duration(d)</code></td><td>Human-readable duration</td><td><code>1.23s</code>, <code>450ms</code></td></tr>
        <tr><td><code>format.Percent(pct)</code></td><td>Percentage</td><td><code>73.2%</code></td></tr>
        <tr><td><code>format.BulletList(items)</code></td><td>Bullet-point list</td><td><code>• item 1\n• item 2</code></td></tr>
        <tr><td><code>format.Warning(msg)</code></td><td>Warning prefix</td><td><code>⚠ msg</code></td></tr>
        <tr><td><code>format.KeyValue(k, v)</code></td><td>Key-value pair</td><td><code>Key: Value</code></td></tr>
        <tr><td><code>format.Summary(pairs)</code></td><td>Summary block</td><td>Key-value summary</td></tr>
      </tbody>
    </table>
  </div>
  ...
  <CodeBlock
    lang="go"
    code={`&mcp.TextContent{Text: formattedString}`}
  />
  ...
  <p>
    Screenshots are base64-encoded and embedded directly in the MCP response. The
    LLM can display or reason about them.
  </p>
</DocPage>
