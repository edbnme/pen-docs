...
>
  ...
  <p>
    Take a V8 heap snapshot. Streamed to disk, so even massive heaps won't blow
    up memory.
  </p>
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>forceGC</code></td><td>bool</td><td>true</td><td
            >Force GC before snapshot</td
          ></tr
        >
        <tr
          ><td><code>includeDOM</code></td><td>bool</td><td>false</td><td
            >Include detached DOM node analysis</td
          ></tr
        >
        <tr
          ><td><code>maxDepth</code></td><td>int</td><td>3</td><td
            >Retained size analysis depth (1–10)</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      <thead
        ><tr
          ><th>Param</th><th>Type</th><th>Required</th><th>Description</th></tr
        ></thead
      >
      <tbody>
        <tr
          ><td><code>snapshotA</code></td><td>string</td><td>yes</td><td
            >ID of first snapshot</td
          ></tr
        >
        <tr
          ><td><code>snapshotB</code></td><td>string</td><td>yes</td><td
            >ID of second snapshot</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>action</code></td><td>string</td><td>—</td><td
            ><code>"start"</code> or <code>"stop"</code></td
          ></tr
        >
        <tr
          ><td><code>trackAllocations</code></td><td>bool</td><td>true</td><td
            >Track allocation stacks</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    CDP: <code>HeapProfiler.startTrackingHeapObjects</code> /
    <code>stopTrackingHeapObjects</code>.
  </p>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        ...
        >
        <tr
          ><td><code>samplingInterval</code></td><td>int</td><td>32768</td><td
            >Bytes between samples</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    CDP: <code>HeapProfiler.startSampling</code> / <code>stopSampling</code> /
    <code>getSamplingProfile</code>.
  </p>
      ...
      <tbody>
        <tr
          ><td><code>duration</code></td><td>int</td><td>5</td><td
            >Seconds to profile (1–30)</td
          ></tr
        >
        <tr
          ><td><code>sampleRate</code></td><td>int</td><td>100</td><td
            >Sampling interval in microseconds (min 10)</td
          ></tr
        >
        <tr
          ><td><code>topN</code></td><td>int</td><td>20</td><td
            >Number of top hotspot functions</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Grab a Chrome trace (DevTools Timeline). Streamed to disk via <code
      >IO.read</code
    >.
  </p>
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>duration</code></td><td>int</td><td>5</td><td
            >Seconds to trace (1–30)</td
          ></tr
        >
        <tr
          ><td><code>categories</code></td><td>[]string</td><td>—</td><td
            >Chrome trace categories</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Crunch a previously captured trace file. Pulls out long tasks (&gt;50ms),
    CLS, LCP, slowest resources, and frame timing.
  </p>
  <div class="table-wrapper">
    <table>
      <thead
      ...
      <tbody>
        <tr
          ><td><code>file</code></td><td>string</td><td>—</td><td
            >Path to trace JSON file (from <code>pen_capture_trace</code>)</td
          ></tr
        >
        <tr
          ><td><code>topN</code></td><td>int</td><td>10</td><td
            >Number of top items per category</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Max file size: 100 MB. Supports both <code>{"{"}"traceEvents":[...]}</code> wrapper
    and plain array formats.
  </p>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>disableCache</code></td><td>bool</td><td>true</td><td
            >Disable browser cache</td
          ></tr
        >
        <tr
          ><td><code>clearFirst</code></td><td>bool</td><td>true</td><td
            >Clear previously captured data</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>sortBy</code></td><td>string</td><td
            ><code>"time"</code></td
          ><td
            >Sort: <code>time</code>, <code>size</code>, <code>status</code>,
            <code>duration</code></td
          ></tr
        >
        <tr
        ...
        >
        <tr
          ><td><code>limit</code></td><td>int</td><td>50</td><td>Max entries</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>urlPattern</code></td><td>string</td><td
            >URL substring to match</td
          ></tr
        >
        <tr
          ><td><code>requestID</code></td><td>string</td><td
            >Exact request ID from waterfall</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Identify render-blocking resources. No parameters. Returns synchronous
    scripts and blocking stylesheets.
  </p>
  ...
  <p>
    Collect JavaScript code coverage: per-function byte ranges, used vs unused
    percentages.
  </p>
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>callCount</code></td><td>bool</td><td>true</td><td
            >Include per-function call counts</td
          ></tr
        >
        <tr
          ><td><code>detailed</code></td><td>bool</td><td>false</td><td
            >Block-level coverage granularity</td
          ></tr
        >
        <tr
          ><td><code>navigate</code></td><td>string</td><td>—</td><td
            >URL to navigate to before collecting</td
          ></tr
        >
        <tr
          ><td><code>topN</code></td><td>int</td><td>20</td><td
            >Top N scripts by unused bytes</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    CDP: <code>Profiler.startPreciseCoverage</code> /
    <code>stopPreciseCoverage</code>.
  </p>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>navigate</code></td><td>string</td><td>—</td><td
            >URL to navigate to for full-page CSS</td
          ></tr
        >
        <tr
          ><td><code>topN</code></td><td>int</td><td>20</td><td
            >Top N stylesheets by unused rules</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    CDP: <code>CSS.startRuleUsageTracking</code> /
    <code>stopRuleUsageTracking</code>.
  </p>
  ...
  <p>
    Grab real-time performance counters (instant, no profiling needed). No
    parameters.
  </p>
  <p>
    CDP: <code>Performance.getMetrics</code>. Returns JSHeapUsedSize, Nodes,
    LayoutCount, RecalcStyleCount, ScriptDuration, TaskDuration, etc.
  </p>
  ...
  <p>
    Quick accessibility sweep: missing alt text, unlabeled inputs, contrast
    problems, ARIA violations.
  </p>
  <div class="table-wrapper">
    <table>
      <thead><tr><th>Param</th><th>Type</th><th>Description</th></tr></thead>
      <tbody>
        <tr
          ><td><code>selector</code></td><td>string</td><td
            >CSS selector to scope (default: entire page)</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>refresh</code></td><td>bool</td><td>false</td><td
            >Re-enable debugger for fresh list</td
          ></tr
        >
        <tr
          ><td><code>filter</code></td><td>string</td><td>—</td><td
            >Filter by URL substring</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    CDP: <code>Debugger.enable</code>, <code>scriptParsed</code> events. Reports source
    map URLs as metadata (does not fetch or parse source maps).
  </p>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>scriptID</code></td><td>string</td><td>—</td><td
            >Script ID from <code>pen_list_sources</code></td
          ></tr
        >
        <tr
          ><td><code>urlPattern</code></td><td>string</td><td>—</td><td
            >URL substring (first match)</td
          ></tr
        >
        <tr
          ><td><code>maxLines</code></td><td>int</td><td>200</td><td
            >Truncate after N lines</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    CDP: <code>Debugger.getScriptSource</code>. You get the code as V8 sees it —
    bundled or minified if that's what's loaded.
  </p>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>query</code></td><td>string</td><td>—</td><td
            >Search query (required)</td
          ></tr
        >
        <tr
          ><td><code>isRegex</code></td><td>bool</td><td>false</td><td
            >Treat query as regex</td
          ></tr
        >
        <tr
          ><td><code>caseSensitive</code></td><td>bool</td><td>false</td><td
            >Case-sensitive search</td
          ></tr
        >
        <tr
          ><td><code>maxResults</code></td><td>int</td><td>50</td><td
            >Max results across scripts</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Start capturing console output and exceptions. Call this before <code
      >pen_console_messages</code
    >.
  </p>
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>clearFirst</code></td><td>bool</td><td>false</td><td
            >Clear existing messages before starting</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>level</code></td><td>string</td><td>—</td><td
            >Filter: <code>error</code>, <code>warning</code>, <code>log</code>,
            <code>info</code>, <code>debug</code></td
          ></tr
        >
        <tr
        ...
        >
        <tr
          ><td><code>clear</code></td><td>bool</td><td>false</td><td
            >Clear messages after reading</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Run a full Lighthouse audit. Needs the Lighthouse CLI (<code
      >npm install -g lighthouse</code
    >).
  </p>
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>categories</code></td><td>[]string</td><td
            ><code>["performance","accessibility","best-practices","seo"]</code
            ></td
          ><td>Categories to audit</td></tr
        >
        <tr
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>targetId</code></td><td>string</td><td
            >Target ID from <code>pen_list_pages</code></td
          ></tr
        >
        <tr
          ><td><code>urlPattern</code></td><td>string</td><td
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>action</code></td><td>string</td><td>—</td><td
            ><code>goto</code>, <code>back</code>, <code>forward</code>, or
            <code>reload</code> (required)</td
          ></tr
        >
        <tr
          ><td><code>url</code></td><td>string</td><td>—</td><td
            >URL (required when action is <code>goto</code>)</td
          ></tr
        >
        <tr
          ><td><code>wait</code></td><td>int</td><td>2</td><td
            >Seconds to wait after navigation (0–30)</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <p>
    Force V8 garbage collection. No parameters. Rate limit: <strong
      >5s cooldown</strong
    >.
  </p>
      ...
      <tbody>
        <tr
          ><td><code>selector</code></td><td>string</td><td>—</td><td
            >CSS selector for element capture</td
          ></tr
        >
        <tr
          ><td><code>fullPage</code></td><td>bool</td><td>false</td><td
            >Full page capture</td
          ></tr
        >
        <tr
          ><td><code>format</code></td><td>string</td><td><code>"png"</code></td
          ><td><code>png</code>, <code>jpeg</code>, or <code>webp</code></td
          ></tr
        >
        <tr
          ><td><code>quality</code></td><td>int</td><td>—</td><td
            >0–100 for jpeg/webp</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>device</code></td><td>string</td><td
            >Preset: <code>iPhone 14</code>, <code>Pixel 7</code>,
            <code>iPad</code></td
          ></tr
        >
        <tr
          ><td><code>cpuThrottling</code></td><td>float64</td><td
            >CPU slowdown factor (e.g., 4 = 4x slower)</td
          ></tr
        >
        <tr
  ...
  <p>
    Run JavaScript in the page context. <strong
      >Requires the <code>--allow-eval</code> flag.</strong
    >
  </p>
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>expression</code></td><td>string</td><td>—</td><td
            >JS expression (required)</td
          ></tr
        >
        <tr
          ><td><code>returnByValue</code></td><td>bool</td><td>true</td><td
            >Return result by value</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>pen_heap_snapshot</code></td><td>10s</td><td
            >Heavy GC + disk I/O</td
          ></tr
        >
        <tr
          ><td><code>pen_capture_trace</code></td><td>5s</td><td
            >Exclusive Tracing domain</td
          ></tr
        >
        <tr
          ><td><code>pen_collect_garbage</code></td><td>5s</td><td
            >V8 GC is expensive</td
          ></tr
        >
      </tbody>
    </table>
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody>
        <tr
          ><td><code>pen_heap_snapshot</code></td><td
            ><code>pen_heap_diff</code></td
          ><td>Snapshot ID</td></tr
        >
        <tr
          ><td><code>pen_list_pages</code></td><td
            ><code>pen_select_page</code></td
          ><td>Target ID</td></tr
        >
        <tr
          ><td><code>pen_network_waterfall</code></td><td
            ><code>pen_network_request</code></td
          ><td>Request ID</td></tr
        >
        <tr
          ><td><code>pen_list_sources</code></td><td
            ><code>pen_source_content</code>, <code>pen_search_source</code></td
          ><td>Script ID</td></tr
        >
        <tr
          ><td><code>pen_capture_trace</code></td><td
            ><code>pen_trace_insights</code></td
          ><td>Trace File Path</td></tr
        >
        <tr
          ><td><code>pen_console_enable</code></td><td
